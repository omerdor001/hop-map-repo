...
- **Test Suite** — 732 passing tests across unit, integration, and E2E layers
...
│   │   └── router.py                   # GET /api/me, PATCH /api/me/plan, DELETE /api/me/telegram
...
│   └── vite.config.js
│
├── hopmap-landing/                     # Marketing landing page (React + TypeScript + Vite)
...
732 tests passing across unit, integration, and E2E layers with 0 failures.
