...
- **Test Suite** — 418 passing tests across unit, integration, and E2E layers
...
│       ├── integration_tests/          # 8 files — endpoint tests via httpx
│       └── unit_tests/                 # 9 files — filter, auth, DB, LLM, health, rate limiter
│
...
418 tests passing across unit, integration, and E2E layers with 0 failures.
...
└── unit_tests/
    ...
    ├── test_circuit_breaker.py    54 — circuit breaker open/closed/half-open states
    ├── test_db_unit.py            67 — connection pool, ping, collection helpers
    ├── test_health_checks.py      45 — MongoDB, Ollama, words-filter health checks
